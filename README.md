...
Create a Supabase project and obtain a Digital Commons API key. Fill in the corresponding variables:

```bash
PUBLIC_SUPABASE_URL
PUBLIC_SUPABASE_ANON_KEY
DIGITALCOMMONS_API_KEY
```
...
#AI Use
This project included an open conversation with claude-3.5-sonnet through the Cursor AI IDE.
